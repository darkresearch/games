...
export class DarkForest__factory {
  static readonly abi = _abi;
  static createInterface(): DarkForestInterface {
    return new utils.Interface(_abi) as DarkForestInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DarkForest {
    return new Contract(address, _abi, signerOrProvider) as DarkForest;
  }
}
