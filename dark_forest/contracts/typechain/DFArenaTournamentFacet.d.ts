...
interface DFArenaTournamentFacetInterface extends ethers.utils.Interface {
  functions: {
...
export class DFArenaTournamentFacet extends BaseContract {
  ...
  interface: DFArenaTournamentFacetInterface;
