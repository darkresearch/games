 ...
 */
export declare type VoyageId = Abstract<string, 'VoyageId'>;
/**
 ...
 */
export declare type LocationId = Abstract<string, 'LocationId'>;
/**
 ...
 */
export declare type EthAddress = Abstract<string, 'EthAddress'>;
/**
 ...
 * in `serde`.
 */
export declare type ArtifactId = Abstract<string, 'ArtifactId'>;
