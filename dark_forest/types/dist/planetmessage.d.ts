 ...
 */
export declare type PlanetMessageType = Abstract<string, 'PlanetMessageType'>;
/**
 * Each message type has a corresponding entry here.
 */
export declare const PlanetMessageType: {
    readonly EmojiFlag: PlanetMessageType;
};
/**
 ...
 */
export declare type PlanetMessageBody = EmojiFlagBody | unknown;
/**
